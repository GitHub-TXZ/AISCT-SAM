...
if __name__ == '__main__':
    # https://www.cnblogs.com/cy0628/p/15572685.html
    import os
    ...
    model = DeformConv2d(inc=256, outc=384, modulation=True).to(device)
    input_shape = (1, 256, 192, 192)  #(batch_size, channels, height, width, depth)
