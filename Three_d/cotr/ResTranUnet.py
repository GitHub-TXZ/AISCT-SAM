...
import numpy as np
from Three_d.cotr import CNNBackbone
from Three_d.cotr.DeTrans.DeformableTrans import DeformableTransformer
from Three_d.cotr.DeTrans.position_encoding import build_position_encoding
