...
from .aff import Circle, BiFusion_block
...
class Generic_UNet(nn.Module):
    ...
    def __init__(self, input_channels=1, base_num_features=32, num_classes=2, num_pool=5, num_conv_per_stage=2,
        ...
        # self.fuse.append(BiFusion_block(output_features, output_features, 4, output_features, output_features))
