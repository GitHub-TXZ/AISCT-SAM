...
class UTNet(nn.Module):
    ...
    def __init__(self, in_chan=1, base_chan=32, num_classes=2, reduce_size=8, block_list='234', num_blocks=[1, 2, 4], projection='interp', num_heads=[2,4,8], attn_drop=0., proj_drop=0., bottleneck=False, maxpool=True, rel_pos=True, aux_loss=False):
